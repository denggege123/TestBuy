...
<body style="margin: 1px;">
	<table id="dg" title="订单管理" class="easyui-datagrid" fitColumns="true"
		pagination="true" rownumbers="true" url="order_list.action" fit="true"
		toolbar="#tb">
		<thead>
			<tr>
				...
				<th field="user.id" width="50" align="center"
					formatter="formatUserId">订单人ID</th>
				<th field="user.userName" width="100" align="center"
					formatter="formatUserName">订单人用户名</th>
	...
	<div id="tb">
		...
		<div>
			...
			&nbsp;订单人：&nbsp;<input type="text" id="s_userName" size="20" /> <a
		...
		<table id="dg2" title="订单商品列表" class="easyui-datagrid"
			...
			<thead>
				<tr>
					...
					<th field="proPic" width="100" align="center"
