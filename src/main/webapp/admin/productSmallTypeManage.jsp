...
<body style="margin: 1px;">
	<table id="dg" title="商品小类管理" class="easyui-datagrid" fitColumns="true"
		pagination="true" rownumbers="true" url="productSmallType_list.action"
		fit="true" toolbar="#tb">
		<thead>
			<tr>
	...
	<div id="tb">
		<div>
			<a href="javascript:openProductSmallTypeAddDialog()"
				class="easyui-linkbutton" iconCls="icon-add" plain="true">添加</a> <a
				href="javascript:openProductSmallTypeModifyDialog()"
				class="easyui-linkbutton" iconCls="icon-edit" plain="true">修改</a> <a
				href="javascript:deleteProductSmallType()" class="easyui-linkbutton"
				iconCls="icon-remove" plain="true">删除</a>
		</div>
		<div>
			&nbsp;商品小类名称：&nbsp;<input type="text" id="s_productSmallTypeName"
				size="20" onkeydown="if(event.keyCode==13) searchProductSmallType()" />
			<a href="javascript:searchProductSmallType()"
	...
	<div id="dlg" class="easyui-dialog"
		...
		<form id="fm" method="post">
			<table cellspacing="8px">
				<tr>
					<td>所属大类：</td>
					<td colspan="3"><input class="easyui-combobox" id="bName"
						name="productSmallType.bigType.id"
				...
				<tr>
					...
					<td colspan="3"><input type="text" id="name"
						name="productSmallType.name" class="easyui-validatebox"
						required="true" /></td>
				</tr>
				<tr>
					<td valign="top">备注：</td>
					<td colspan="3"><textarea rows="7" cols="50" id="remarks"
							name="productSmallType.remarks"></textarea></td>
				</tr>
			</table>
		</form>
	</div>
	...
	<div id="dlg-buttons">
		<a href="javascript:saveProductSmallType()" class="easyui-linkbutton"
			iconCls="icon-ok">保存</a> <a
			href="javascript:closeProductSmallTypeDialog()"
