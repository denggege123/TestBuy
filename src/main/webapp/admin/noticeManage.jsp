...
<body style="margin: 1px;">
	<table id="dg" title="公告管理" class="easyui-datagrid" fitColumns="true"
		pagination="true" rownumbers="true" url="notice_list.action"
		fit="true" toolbar="#tb">
		<thead>
			<tr>
				...
				<th field="content" width="400" align="center"
					formatter="formatContent">内容</th>
			</tr>
		</thead>
	</table>
	...
	<div id="tb">
		...
		<div>
			&nbsp;公告名称：&nbsp;<input type="text" id="s_noticeTitle" size="20"
				onkeydown="if(event.keyCode==13) searchNotice()" /> <a
				href="javascript:searchNotice()" class="easyui-linkbutton"
			...
			<table cellspacing="8px">
				<tr>
					...
					<td colspan="4"><input type="text" id="title"
						name="notice.title" class="easyui-validatebox" required="true"
						style="width: 300px" /></td>
				</tr>
				<tr>
					<td valign="top">公告内容：</td>
					<td colspan="4"><textarea id="content" name="notice.content"
							class="ckeditor"></textarea> <input type="hidden" id="createTime"
						name="notice.createTime" /></td>
				</tr>
			</table>
		</form>
	</div>
