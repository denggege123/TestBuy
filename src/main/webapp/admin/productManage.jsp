...
<body style="margin: 1px;">
	<table id="dg" title="商品管理" class="easyui-datagrid" fitColumns="true"
		pagination="true" rownumbers="true" url="product_list.action"
		fit="true" toolbar="#tb">
		<thead>
			<tr>
				<th field="cb" checkbox="true" align="center"></th>
				<th field="id" width="50" align="center">编号</th>
				<th field="proPic" width="150" align="center"
				...
				<th field="smallType.id" width="100" align="center"
					formatter="formatSmallTypeId" hidden="true">所属商品小类id</th>
				<th field="smallType.name" width="100" align="center"
					formatter="formatSmallTypeName">所属商品小类</th>
				<th field="bigType.id" width="100" align="center"
					formatter="formatBigTypeId" hidden="true">所属商品大类id</th>
				<th field="bigType.name" width="100" align="center"
					formatter="formatBigTypeName">所属商品大类</th>
				<th field="hot" width="50" align="center" formatter="formatHot">是否热卖</th>
				<th field="specialPrice" width="50" align="center"
					formatter="formatSpecialPrice">是否特价</th>
	...
	<div id="tb">
		<div>
			<a href="javascript:openProductAddDialog()" class="easyui-linkbutton"
				...
				href="javascript:setProductHot()" class="easyui-linkbutton"
				iconCls="icon-hot" plain="true">设置为热卖</a> <a
				href="javascript:setProductSpecialPrice()" class="easyui-linkbutton"
				iconCls="icon-special" plain="true">设置为特价</a>
		</div>
		<div>
			...
			<table cellspacing="8px">
				<tr>
					...
					<td colspan="4"><input type="text" id="name"
						name="product.name" class="easyui-validatebox" required="true"
						style="width: 300px" /></td>
				</tr>
				<tr>
					<td>价格：</td>
					<td colspan="4"><input type="text" id="price"
						name="product.price" class="easyui-validatebox" required="true" /></td>
				</tr>
				<tr>
					<td>库存：</td>
					<td colspan="4"><input type="text" id="stock"
						name="product.stock" class="easyui-validatebox" required="true" /></td>
				</tr>
				<tr>
					<td>商品图片：</td>
				...
				<tr>
					<td>所属大类：</td>
					<td colspan="4"><input class="easyui-combobox" id="bName"
						name="product.bigType.id"
						data-options="panelHeight:'auto',editable:false,valueField:'id',textField:'name',url:'productBigType_comboList.action'" />
					</td>
				</tr>
				<tr>
					<td>所属小类：</td>
					<td colspan="4"><input class="easyui-combobox" id="sName"
						name="product.smallType.id"
						data-options="panelHeight:'auto',editable:false,valueField:'id',textField:'name',url:'productSmallType_comboList.action'" />
					</td>
				</tr>
				<tr>
					<td valign="top">备注：</td>
					<td colspan="4"><textarea rows="5" cols="50" id="description"
							name="product.description"></textarea> <input type="hidden"
						id="proPic" name="product.proPic" /> <input type="hidden" id="hot"
						name="product.hot" /> <input type="hidden" id="hotTime"
						name="product.hotTime" /> <input type="hidden" id="specialPrice"
						name="product.specialPrice" /> <input type="hidden"
						id="specialPriceTime" name="product.specialPriceTime" /></td>
				</tr>
			</table>
		</form>
	</div>
