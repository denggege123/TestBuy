		...
		<form action="user_save.action" method="post"
			...
			<table class="form">
				<tr>
					...
					<td><input type="text" class="text" name="user.userName"
						value="${user.userName }" readonly="readonly" /></td>
				</tr>
				<tr>
					<td class="field">姓名：</td>
					<td><input type="text" class="text" id="trueName"
						name="user.trueName" value="${user.trueName }" /></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><c:choose>
							<c:when test="${user.sex=='男' }">
								<input type="radio" name="user.sex" value="男" checked="checked" />男 <input
									type="radio" name="user.sex" value="女" />女
						</c:when>
							<c:otherwise>
								<input type="radio" name="user.sex" value="男" />男 <input
									type="radio" name="user.sex" value="女" checked="checked" />女
						</c:otherwise>
						</c:choose></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input type="text" class="text" id="address"
						name="user.address" value="${user.address }" /></td>
				</tr>
				<tr>
					<td class="field">身份证号：</td>
					<td><input class="text" type="text" id="dentityCode"
						name="user.dentityCode" value="${user.dentityCode }" /></td>
				</tr>
				<tr>
