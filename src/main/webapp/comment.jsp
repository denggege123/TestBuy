					...
					<c:forEach items="${commentList }" var="comment">
						<li>
							<dl>
								...
								<dd class="author">
									网友：${comment.nickName } <span class="timer"> <fmt:formatDate
											value="${comment.createTime }" type="date"
											pattern="yyyy-MM-dd" />
									</span>
									<c:if test="${not empty comment.replyContent }">
										<dd>
											官方回复：${comment.replyContent }&nbsp;&nbsp; <span class="timer">
												<fmt:formatDate value="${comment.replyTime }" type="date"
													pattern="yyyy-MM-dd" />
											</span>
										</dd>
									</c:if>
						...
						<table>
							...
							<tr>
								...
								<td><label class="ui-blue"><input type="submit"
										name="submit" value="提交留言" /> </label>&nbsp;&nbsp;<font id="error"
